...
namespace AnswerPoortal.Controllers
{
    ...
    public class ConfigsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,answerPriceK,unlockPriceM,evaluationPriceE,silverPriceS,goldPriceG,platinumPriceP")] Config config)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,answerPriceK,unlockPriceM,evaluationPriceE,silverPriceS,goldPriceG,platinumPriceP")] Config config)
        {
            if (ModelState.IsValid)
            {
